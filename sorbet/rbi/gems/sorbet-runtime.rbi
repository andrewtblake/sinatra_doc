...
class T::Private::DeclState
  ...
  def without_on_method_added; end
end
module T::Utils
...
module T::Private::Sealed
  def self.declare(mod, decl_file); end
  def self.sealed_module?(mod); end
  def self.validate_inheritance(this_line, parent, verb); end
end
...
class T::Types::TypedEnumerable::Untyped < T::Types::TypedEnumerable
  def initialize; end
  def valid?(obj); end
end
...
class T::Types::OpusEnum < T::Types::Base
...
class T::Types::TypedArray::Untyped < T::Types::TypedArray
  def initialize; end
  def valid?(obj); end
end
...
class T::Types::TypedEnumerator::Untyped < T::Types::TypedEnumerator
  def initialize; end
  def valid?(obj); end
end
...
class T::Types::TypedHash::Untyped < T::Types::TypedHash
  def initialize; end
  def valid?(obj); end
end
...
class T::Types::TypedSet::Untyped < T::Types::TypedSet
  def initialize; end
  def valid?(obj); end
end
